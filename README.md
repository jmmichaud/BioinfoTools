...
**[Count DNA nucleotides](https://github.com/jmmichaud/BioinfoTools/CountDNAnulcleotides.py)** - PYTHON 3.6.  Inputs a string of DNA.  Outputs the number of each nucleotide
    ACGT respectively as a space separated string of integers.
    
**[Reverse Complement](https://github.com/jmmichaud/BioinfoTools/ReverseComplement.py)** - PYTHON 3.6.  Inputs a DNA string.  Outputs the reverse complement of the DNA strand.
